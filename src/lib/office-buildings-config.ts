...
export const BACKGROUND_PRESETS: BackgroundPreset[] = [
  ...
  {
    id: 'cyberpunk-wide-hq',
    name: 'Cyberpunk Wide Edition',
    imageSrc: '/room/room-office-w.png',
    thumbnail: '/room/room-office-w.png',
    description: 'สำนักงานสไตล์ Cyberpunk 2.5D มุมกว้าง สว่างคมชัด',
    tag: 'Wide 16:9',
  },
];
